		...
		<div class="tc _o">
			<div class="animate_left jn/2">
				...
				<p style="margin-top: 10px;" class="">
					Dzięki materiałom przygotowanym w ramach tego projektu dowiesz się więcej o związku tych
					dwóch sąsiadujących ze sobą krajów, ich historii, kulturze i tradycji.
				</p>
				<p class="fq">
					Będziesz podróżować przez historyczne epoki i poruszać różne tematy, takie jak kultura,
					sztuka, historia i inne, aby odkryć podobieństwa i porównać, co łączy ludzi z Białorusi i
					Polski.
				</p>

				<div class="tc tf yo zf mt-6">
					<a href="/app" class="ek jk lk gh gi hi rg ml il vc _d _l">Do aplikacji</a>

					<span class="tc sf">
						<a href="mailto:oleg@darkdev.games" class="inline-block ek xj kk wm text-red-500">
							oleg@darkdev.games
						</a>
	...
	<div id="about" class="bb ze ki xn wq">
		<div class="tc wf gg qq">
			<div class="animate_left xc gn gg jn/2 i">
				<div>
					<!-- <img src="images/shapes/shape-05.svg" alt="Shape" class="h -ud-left-5 x" /> -->
					<img src="images/bg/about_1.png" alt="About" class="ib" />
					<img src="images/bg/about_2.png" alt="About" />
				</div>
				<div>
					<img src="images/shapes/shape-06.svg" alt="Shape" />
					<img src="images/bg/about_3.png" alt="About" class="ob gb" />
					<img src="images/shapes/shape-07.svg" alt="Shape" class="bb" />
				</div>
			</div>
			...
			<div class="animate_right jn/2">
				...
				<p class="uo">
					W grze wykorzystacie swoją uważność i umiejętność pracy w zespole. Zobaczycie, jak wiele
					łączy nasze narody i jak wiele można się o sobie nawzajem dowiedzieć.
				</p>
				...
				>
					...
					<li class="ml-8 list-disc">
						<a href="#history">
							relacje między narodami Białorusi i Polski i ich wkład w politykę regionalną i
							międzynarodową.
						</a>
					</li>
				</ul>
	...
	<div class="flex items-center mx-auto container justify-between py-2 max-w-5xl">
		<div>
			<span style="font-family: 'Impact'; font-size: 1.8rem; " class="text-gray-900"
				>Rozpocznij poznawanie kultury białoruskiej i polskiej
			</span>
		</div>
		<a
			style="font-family: 'Impact'; font-size: 2.5rem; "
			href="https://github.com/oleg-darkdev/by-PL/tree/master/static/print"
		...
		>
			...
			<span class="hover:underline text-gray-900 focus-visible:underline">Bezpłatne</span>
		</a>
	</div>
</section>
...
*/
	...
	*,
	...
	.gh {
		--tw-bg-opacity: 1;
		background-color: rgb(235 90 83 / var(--tw-bg-opacity));
	}
	.hh\/20 {
	...
	.sh {
		...
		background-color: rgb(235 90 83 / var(--tw-bg-opacity)) !important;
	}
	.th {
		fill: #79808a;
	}
	...
	.mk {
		--tw-text-opacity: 1;
		color: rgb(235 90 83 / var(--tw-text-opacity));
	}
	.nk {
	...
	.rl:hover {
		--tw-border-opacity: 1;
		border-color: rgb(235 90 83 / var(--tw-border-opacity));
	}

	.rl\/40:hover {
		border-color: rgb(235 90 83/ 0.4);
	}
